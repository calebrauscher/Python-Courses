...
def board_contains_word_in_row(board, word):
    ...
    True
    >>> board_contains_word_in_row([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], 'COW')
    False
    """
...
def board_contains_word(board, word):
    ...
    True
    >>> board_contains_word([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], 'BUG')
    False
...
def num_words_on_board(board, words):
    ...
    3
    >>> num_words_on_board([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], ['ANT', 'BOX', 'COW'])
    1
    """
    number_words = 0
    for word in words:
